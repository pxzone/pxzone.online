                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6 mb-3">
                                                <form id="_update_image_form">
                                                    ...
                                                    <div class="mt-2">
                                                        <button class="btn btn-primary rounded c-white" type="submit" id="_update_image_btn">Update Image</button>
                                        ...
                                        <form id="_edit_blog_form">
                                            <div class="row">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" name="published_date" class="form-control" value="<?=$article_data['created_at']?>" id="published_date" required/>
                                                    <label for="_published_date">Published Date</label>
                                                </div>
                                                    ...
                                                    <div class="row ">
                                                        <label for="floatingTextarea" class="mb-2">Tags</label>
                                                         <div class="col-lg-4" id="_tags_div">
                                                            ...
                                                            <button class="btn btn-sm btn-dark c-white mt-1" type="button" id="_add_tags_btn_update_form">Add Tags</button>
                                                        </div>
