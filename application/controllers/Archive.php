...
class Archive extends CI_Controller {
    ...
    public function getTopics($topic_id){
        ...
        $data_res = $this->Archive_model->getTopicContent($row_per_page, $row_no);
        $result = $data_res['posts'];
        $all_count = $data_res['count'];
    ...
    public function searchPosts(){
        ...
        $data['row'] = $row_no;
        $data['count'] = $all_count;
        $this->output->set_content_type('application/json', 'utf8mb4_unicode_ci')->set_output(json_encode(array('data'=>$data)));
    }
    // public function getKarmaLog(){
    //     $row_no = $this->input->get('page_no');
    //     // Row per page
    //     $row_per_page = 50;
    //     // Row position
    ...
    //     $data_res = $this->Archive_model->getKarmaLogData($row_per_page, $row_no);
